...
// WARN instead of running a reachable instance on a guessable secret. Kept as
// a named constant so weak_test.go can assert the two never drift apart.
const envExamplePlaceholder = "changeme"
