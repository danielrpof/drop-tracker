...
- [x] **DGST-11**: Each digest message shows the window it covers (e.g. "since [timestamp]")
- [x] **DGST-12**: A digest that would exceed Discord's per-message embed/character limits splits into multiple messages instead of silently truncating content
...
| DGST-11 | Phase 23 | Complete |
| DGST-12 | Phase 23 | Complete |
