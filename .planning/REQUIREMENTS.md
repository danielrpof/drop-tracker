...
- [x] **MGRT-01**: A CI check boots the previously-released image against the current branch's schema and fails the build if the older binary cannot start and stay healthy (backward-compatibility / N-1 check)
