...
- [x] **SYS-02**: The System view also shows a recent-runs history table, the watchlist size, the poll interval, and an about block (app version, schema version, database reachable).
