...
- [ ] **Phase 14: Instance Passphrase Gate** - A configured passphrase puts the watchlist API and Discord-backed actions behind a signed session cookie, with the SPA prompting for it — and stays completely inert when unconfigured
